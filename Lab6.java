...
public class Lab6 {
	...
	public static void main(String[] args) {
		...
		try {System.out.println("Select a main menu choice:");
		...
		while (userChoice != 5) {
			...
			case 2:
				...
				try {
					...
					System.out.println("Arithmetic Error for " + firstNum + " - " + secondNum + ". " + " The second number " +secondNum + " is greater than the first number " + firstNum);
				}
			...
			System.out.println("Select a main menu choice:");
